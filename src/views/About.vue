<template>
  <div id="about">
    <template v-if="locale==='de'">
      ...
      <p>Mitglieder des Vorstands des Vereins entscheidsuche.ch sind Jörn Erbguth und Claudia
    ...
    <template v-if="locale==='fr'">
      ...
      <p>Les membres du comité directeur de l'association entscheidsuche.ch sont Jörn Erbguth et Claudia Schreiber. Le comité peut être contacté sous l'adresse <b-link href="mailto:info@entscheidsuche.ch">info@entscheidsuche.ch</b-link>.</p>
    ...
    <template v-if="locale==='it'">
      ...
      <p>I membri del comitato esecutivo dell'associazione entscheidsuche.ch sono Jörn Erbguth e Claudia Schreiber. Il consiglio può essere contattato all'indirizzo <b-link href="mailto:info@entscheidsuche.ch">info@entscheidsuche.ch</b-link>.</p>
